...
class RegistroController
{
    ...
    public static function crear(Router $router)
    {
        ...
        // Verificar si el usuario ya está registrado en algún evento
    ...
    public static function boleto(Router $router)
    {
        ...
        // Llenar los campos de referencia
        $registro->usuario = Usuario::find($registro->usuario_id);
        $registro->paquete = Paquete::find($registro->paquete_id);

        $router->render('registro/boleto', [
            'titulo' => 'Asistencia a DevWebCamp - Tu Boleto Virtual',
            'registro' => $registro
        ]);
    }
    ...
    public static function conferencias(Router $router)
    {
        ...
        // Validar que el ususario tenga el boleto virtual
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            // Obteber el registro del ususario
            $registro = Registro::where('usuario_id', $_SESSION['id']);
            if (!isset($registro) || $registro->paquete_id !== '1') {
                echo json_encode(['resultado' => false]);
                return;
        ...
        $router->render('registro/conferencias', [
            'titulo' => 'Elige Workshop & Conferencias',
